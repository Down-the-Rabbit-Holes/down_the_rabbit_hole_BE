...
animals = [
  ...
  },
  {
    ...
    photo_url: "https://images.pexels.com/photos/605494/pexels-photo-605494.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=800",
    description: "Grasses are a family of plants with leaves that usually look like blades. Most of them also have hollow stems and many branching roots. The green grass found in yards, the grasses growing on open land, grains, and bamboos all belong to the grass family.",
    top_speed: 'Grass does not move',
    life_span: '7-10 years',
    weight: '0',
    height: '2-24 inches tall',
    length: '0',
    habitat: "Grass is the habitat",
    predators: "Bighorn Sheep",
    prey: "no prey",
    fun_fact: "Grasses are flowering plants, like roses, sunflowers, and daffodils, but they aren't usually thought of as such.",
    animal_type: "plant",
    diet: "water and dirt"
  }
...
csv_file_path = "new_test_animals.csv"
